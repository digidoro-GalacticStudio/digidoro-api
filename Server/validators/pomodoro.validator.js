...
const createPomodoroValidator = [
    body("pomodoro")
        ...
        .bail()
        .isInt({min: 1}).withMessage("pomodoro must be greater than 1"),
    body("break")
        .optional()
        .isInt()
        .withMessage("break must be Integer")
        .bail()
        .isInt({min: 1}).withMessage("break must be greater than 1"),
    body("long_break")
        .optional()
        .isInt()
        .withMessage("long_break must be Integer")
        .bail()
        .isInt({min: 1}).withMessage("long_break must be greater than 1"),
    body("break_pomodoro")
        .optional()
        .isInt()
        .withMessage("break_pomodoro must be Integer")
        .bail()
        .isInt({min: 1}).withMessage("break_pomodoro must be greater than 1"),
    body("pomodoro_day")
        .optional()
        .isInt()
        .withMessage("pomodoro_day must be Integer")
        .bail()
        .isInt({min: 1}).withMessage("pomodoro_day must be greater than 1"),
    body("theme")
        .optional()
        .isHexColor()
